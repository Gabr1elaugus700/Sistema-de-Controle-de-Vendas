...
<head>
  ...
  <script src="../scripts/deleteVendas.js" type="text/javascript"></script>
  ...
  <div class="container">
        ...
        <table >
          ...
          while ($row = mysqli_fetch_assoc($resultado)) {
            ...
            "<td style='display: flex; flex-wrap: nowrap; gap: 5px; justify-content: center;'>
              <button type='button' class='btn btn-primary botao' id='botaoTabela' style='padding: 5px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;'>
                ...
                <button onclick='deletaVenda($id_prod)' type='button' class='btn btn-danger botao' id='botaoExcluir' style='padding: 5px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;'>
    ...
    <div class="mb3">
      <div class="botoes">
        ...
        <button type="submit" class="btn btn-light botao tBot">Filtrar</button>
        <button type="submit" class="btn btn-light botao tBot">Exportar</button>
      </div>
    </div>
