        ...
        <div class="form">
            <form class="formulario" id="form" method="POST" action="../include/insertProd.php">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control input" id="usuario" name="usuario" required="required">
                </div>

                <div class="mb-3">
                    <label class="form-label">Senha:</label>
                    <input class="form-control input" id="senha" name="senha" type="password" required="required">
                </div>
                <button type="button" class="btn botoes" onclick="validaLogin()">Login</button>
            </form>
