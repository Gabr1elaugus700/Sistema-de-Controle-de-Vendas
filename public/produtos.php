...
<head>
    ...
    <script src="../scripts/deleteProd.js" type="text/javascript"></script>
                ...
                <table>
                    ...
                    while ($row = mysqli_fetch_assoc($resultado)) {
                        ...
                        <td style='display: flex; flex-wrap: nowrap; gap: 5px; justify-content: center;'>
                            <button onClick='alteraItem($id)' type='button' class='btn btn-primary' id='botaoTabela' style='padding: 5px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;'>
                            ...
                            <button onClick='deletaProd($id)' type='button' class='btn btn-danger' style='padding: 5px; width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;' >
                                <a>
